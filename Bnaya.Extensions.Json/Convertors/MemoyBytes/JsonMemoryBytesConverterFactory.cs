...
namespace System.Text.Json
{
    public class JsonMemoryBytesConverterFactory : JsonConverterFactory
    {
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="JsonMemoryBytesConverterFactory"/> class from being created.
        /// </summary>
            ...
            JsonSerializerOptions options)
        {
            ...
            throw new NotSupportedException($"[{typeToConvert.Name}] is not supported by {nameof(JsonMemoryBytesConverterFactory)}");
        }
